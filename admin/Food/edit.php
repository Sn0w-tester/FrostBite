                            ...
                            <form name="form1" action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="food_name" name="food_name" type="text" class="form-control"
                                        placeholder="Enter Category" required value="<?php echo $food_name ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="food_description" id=""
                                    ...
                                    while ($row = mysqli_fetch_array($res)) {
                                        ...
                                        <div class="col-lg-4">
                                            <input type="checkbox" name="ingredients[]"
                                                value="<?php echo $row["food_ingredients"] ?>" <?php if (strpos($mystring, $row["food_ingredients"]) !== false) {
                                                       echo "checked";
...
if (isset($_POST["submit1"])) {
    ...
    mysqli_query($link, "UPDATE food set food_name='$_POST[food_name]',food_category='$_POST[food_category]',food_description='$_POST[food_description]',food_original_price='$_POST[food_original_price]',food_discount_price='$_POST[food_discount_price]',food_availability='$_POST[food_availability]',food_veg_nonveg='$_POST[food_veg_nonveg]',food_ingredients='$ingredients' WHERE id=$id") or die(mysqli_error($link));
